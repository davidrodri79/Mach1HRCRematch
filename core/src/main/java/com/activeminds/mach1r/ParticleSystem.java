...
public class ParticleSystem {
    ...
    static class Particle {
        ...
        void update()
        {
            ...
            if(sinMove) {
                position.x += 0.25f*(float) Math.sin((timeLeft + sinMovePhase)/ 20);
                position.z += 0.25f*(float) Math.cos((timeLeft + sinMovePhase)/ 20);
            }
